...
void AVHSHud::DrawHUD()
{
	...
	const ADarkroomCharacter* Player = Cast<ADarkroomCharacter>(GetOwningPawn());
...
void AVHSHud::DrawBattery(float Margin, const ADarkroomCharacter* Player)
{
...
{
	const ADarkroomGameState* State = GetWorld()->GetGameState<ADarkroomGameState>();
...
void AVHSHud::DrawInteractionPrompt(const ADarkroomCharacter* Player)
{
