...
class DARKROOM_API UFlashlightComponent : public UActorComponent
{
	GENERATED_BODY()
...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "Darkroom|Flashlight")
	...
	UFUNCTION(BlueprintPure, Category = "Darkroom|Flashlight")
	...
	UPROPERTY(BlueprintAssignable, Category = "Darkroom|Flashlight")
...
protected:
	/** Текущий заряд, 0..100. */
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Darkroom|Flashlight")
	float Battery = 100.f;
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadWrite, Category = "Darkroom|Flashlight", meta = (ClampMin = "0.0", ClampMax = "100.0"))
