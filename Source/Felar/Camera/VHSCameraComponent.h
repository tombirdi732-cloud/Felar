...
class FELAR_API UVHSCameraComponent : public UCameraComponent
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadWrite, Category = "Felar|VHS|Look", meta = (ClampMin = "0.0", ClampMax = "5.0"))
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadWrite, Category = "Felar|VHS|Look", meta = (ClampMin = "0.0", ClampMax = "2.0"))
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadWrite, Category = "Felar|VHS|Look", meta = (ClampMin = "0.5", ClampMax = "2.0"))
	float Contrast = 1.08f;

	/** Оттенок плёнки. Лёгкий уход в холодную зелень читается как дешёвая кассета. */
	UPROPERTY(EditDefaultsOnly, BlueprintReadWrite, Category = "Felar|VHS|Look")
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadWrite, Category = "Felar|VHS|Look", meta = (ClampMin = "-8.0", ClampMax = "8.0"))
	float ExposureBias = 0.f;

	UPROPERTY(EditDefaultsOnly, BlueprintReadWrite, Category = "Felar|VHS|Look", meta = (ClampMin = "0.0", ClampMax = "1.0"))
	float MotionBlur = 0.35f;

	// --- Дрожание рук ---

	/** Амплитуда покачивания в градусах при DistortionScale = 0. */
	UPROPERTY(EditDefaultsOnly, BlueprintReadWrite, Category = "Felar|VHS|Handheld", meta = (ClampMin = "0.0"))
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadWrite, Category = "Felar|VHS|Handheld", meta = (ClampMin = "0.01"))
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadWrite, Category = "Felar|VHS|Glitch", meta = (ClampMin = "0.02"))
	float GlitchDuration = 0.22f;

	/** Наклон кадра во время сбоя, градусы. */
	UPROPERTY(EditDefaultsOnly, BlueprintReadWrite, Category = "Felar|VHS|Glitch", meta = (ClampMin = "0.0"))
