 ...
 * а AFelarCharacter уже переводит это в шум для ИИ.
 */
UCLASS(ClassGroup = (Felar), meta = (BlueprintSpawnableComponent))
class FELAR_API UFearComponent : public UActorComponent
{
	GENERATED_BODY()
...
public:
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Felar|Fear")
	...
	UFUNCTION(BlueprintPure, Category = "Felar|Fear")
	...
	UPROPERTY(BlueprintAssignable, Category = "Felar|Fear")
...
protected:
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Felar|Fear")
	float Fear = 0.f;

	/** Прирост страха в секунду, пока игрок в темноте. */
	UPROPERTY(EditDefaultsOnly, BlueprintReadWrite, Category = "Felar|Fear", meta = (ClampMin = "0.0"))
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadWrite, Category = "Felar|Fear", meta = (ClampMin = "0.0", ClampMax = "100.0"))
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadWrite, Category = "Felar|Fear", meta = (ClampMin = "0.5"))
